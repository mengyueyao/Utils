...
public class Demo3Fragment extends BaseFragment
    ...
    public void onWidgetClick(View view) {
        ...
        if(view.getId() == R.id.btn_show_about_fragment){
        ...
        }else if(view.getId() == R.id.btn_hide_show){
